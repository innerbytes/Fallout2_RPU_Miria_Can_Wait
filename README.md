...
The instructions below is only for the mod programmers. Please ignore them, if you just want to play the game with Miria Can Wait patch. Use the [Install Manual](#prerequisites) above instead.
